...
→ always building things that solve real problems
...
Built with FastAPI, TF-IDF retrieval, cosine similarity, Claude API · [live demo](https://study-assistant-zeta.vercel.app)
